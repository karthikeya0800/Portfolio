  ...
  return (
    <div className='scroll-smooth bg-red-50 text-red-950 relative pt-28 sm:pt-36 dark:bg-red-900 dark:text-red-50 dark:text-opacity-90'>
      ...
      <main className='flex flex-col items-center px-4'>
        ...
        <div className='opacity-100 transform-none bg-red-200 my-24 h-16 w-1 rounded-full hidden sm:block dark:bg-opacity-20'></div>
        <section
        ...
        >
          ...
          <p className='mb-3'>
            Hey there, I'm Karthikeya, comming from Hyderabad, India.{" "}
            <b>Science🔬, coding💻, and music🎵</b> fuel my soul. Growing up in
            Hyderabad, I was surrounded by a vibrant mix of culture and
            technology. From a young age, I found myself drawn to the wonders of{" "}
            <b>science</b>, tinkering with gadgets and exploring the mysteries
            of the universe. <br /> <br /> As I delved deeper into the world of
            technology, I discovered the art of coding💻. It was like unlocking
            a new language, one that allowed me to create and innovate in ways I
            never thought possible. I immersed myself in the world of
            <b> programming</b>, honing my skills and tackling challenges
            head-on.
            <br /> <br /> Outside of the digital realm, I find joy in the
            simplicity of life. Whether it's a game of badminton🏸 with friends
            or a leisurely stroll in the park, I cherish every moment spent
            outdoors. And let's not forget my love for cricket🏏 - a sport that
            brings people together from all walks of life. <br /> <br />
            With over <b>100 LeetCode</b> challenges conquered, I'm now
            venturing into the realms of{" "}
            <b>data science and machine learning🤖</b>. I'm not just about
            coding; I'm a thinker🧠, constantly seeking solutions to improve
            lives. My motto? Every endeavor should contribute to the betterment
        ...
        <section id='projects' className='scroll-mt-28 mb-28'>
          ...
          <div>
            ...
            <div className='group mb-3 sm:mb-8 last:mb-0 opacity-60 transform scale-80 translate-z-0'>
              <section className='bg-red-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-red-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20'>
                <div className='pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]'>
                  <h3 className='text-2xl font-semibold'>Harmony Homes</h3>
                  <p className='mt-2 leading-relaxed text-red-700 dark:text-white/70'>
                    Developed a static webpage using HTML and Tailwind CSS.
                    Hosted on Google Firebase for accessibility and reliability.
                    <br />
                    <b>
                      Link :&nbsp;
                      <a
                        href='https://karthikeya-realestate-dbad8.web.app/'
                        target='_blank'
                      >
                        <i>
                          <u className='text-blue-300'>Harmony Homes</u>
                        </i>
                      </a>
                    </b>
                  </p>
        ...
        <section
          id='experience'
          className='scroll-mt-28 mb-28 sm:mb-40 lg:w-1/2'
        >
          <h2 className='text-3xl font-medium capitalize mb-8 text-center'>
            <div className='flex items-center justify-center'>
              My experience
